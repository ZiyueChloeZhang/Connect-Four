...
const MainMenu: FC<{ viewRules: () => void, startGame: () => void }> = ({ viewRules, startGame }) => {
    return (
        <div className='m-auto w-[480px] md:border md:shadow rounded-[40px] bg-purple'>
            <div className='flex flex-col items-center px-5 md:px-10 pt-[70px] pb-10 gap-5 text-md font-bold'>
                ...
                />
                <button
                    className='flex items-center justify-between border shadow rounded-[20px] w-full bg-yellow h-[72px] text-start px-4 hover:shadow-purple hover:border-purple'
                    onClick={startGame}
                >
